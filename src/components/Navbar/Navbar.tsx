...
const Navbar = () => {
    ...
    return (
        <nav className={clsx('fixed top-0 left-0 right-0 w-full grid grid-cols-3 items-center px-4 md:px-6 lg:px-12 transition-all duration-200 ease-in-out', isScrolled ? "py-4 text-secondary bg-primary/80 backdrop-blur-md" : "py-8")}>
            ...
            <div className="flex items-center justify-end md:gap-15 lg:gap-30">
                <div className="flex items-center gap-2">
                    ...
                    <span>/</span>
                    <Link href={"/register"} className="hidden cursor-pointer text-sm font-medium tracking-widest md:block hover:underline">
                        REGISTER
                    </Link>
                </div>
                <CartButton />
